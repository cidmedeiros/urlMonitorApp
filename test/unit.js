...
unit['tools.getANumber should return a number'] = function(done){
...
unit['tools.getANumber should return 1'] = function(done){
  var val = tools.getANumber();
...
unit['tools.getNumberOne should return 2'] = function(done){
  var val = tools.getANumber();
