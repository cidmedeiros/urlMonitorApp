...
class _events extends events{}; //The extends keyword is used to create a child class of another class (parent). The child class inherits all the methods from another class. Inheritance is useful for code reusability: reuse properties and methods of an existing class when you create a new class.
const e = new _events();
const os = require('os');
const v8 = require('v8');
...
cli.responders.moreLogInfo = function(str){
  ...
  if(logFileName){
    cli.verticalSpace();
    // Decompress it
    logs.decompress(logFileName,function(err,strData){
      if(!err && strData){
        console.log('decompressing...');
        // Split it into lines
        var arr = strData.split('\n');
        arr.forEach(function(jsonString){
          var logObject = tools.parseJsonToObject(jsonString);
