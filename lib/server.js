...
server.unifiedServer = (req, res) => {
    ...
    req.on('end', () =>{
        ...
        /* //setting up a GENERAL Callback to router request response according to what was defined by the handlers file. The general handler calls the chosen handler which hydrates
        the general callback (statusCode, handlerPayload, contentType).
        The hydrated callback is used to craft an http response to the request received.
        */
